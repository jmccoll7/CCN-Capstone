...
export type PostSnippetFragment = { __typename?: 'Post', id: number, createdAt: any, creatorId: number, title: string, points: number, textSnippet: string, voteStatus?: number | null, creator: { __typename?: 'User', id: number, username: string } };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, createdAt: any, creatorId: number, title: string, points: number, textSnippet: string, voteStatus?: number | null, creator: { __typename?: 'User', id: number, username: string } }> } };
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: number, createdAt: any, creatorId: number, title: string, points: number, textSnippet: string, text: string, voteStatus?: number | null, creator: { __typename?: 'User', id: number, username: string } } | null };
 ...
 *
 * To run a query within a React component, call `useGetItemPricesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetItemPricesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetItemPricesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetItemPricesQuery(baseOptions?: Apollo.QueryHookOptions<GetItemPricesQuery, GetItemPricesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetItemPricesQuery, GetItemPricesQueryVariables>(GetItemPricesDocument, options);
      }
export function useGetItemPricesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetItemPricesQuery, GetItemPricesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetItemPricesQuery, GetItemPricesQueryVariables>(GetItemPricesDocument, options);
        }
export type GetItemPricesQueryHookResult = ReturnType<typeof useGetItemPricesQuery>;
export type GetItemPricesLazyQueryHookResult = ReturnType<typeof useGetItemPricesLazyQuery>;
export type GetItemPricesQueryResult = Apollo.QueryResult<GetItemPricesQuery, GetItemPricesQueryVariables>;
